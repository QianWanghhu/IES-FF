...
samples_import = np.loadtxt(f'{file_settings()[0]}adaptive/rmse_iter1/samples_selected.txt')
...
import pickle
pce_load = pickle.load(open(f'{file_settings()[0]}\pce-rmse.pkl', "rb"))
...
np.savetxt(f'{file_settings()[0]}adaptive/rmse_iter1/train_samples.txt', train_set)
...
pickle.dump(approx_update, open(f'{file_settings()[0]}adaptive/rmse_iter1/pce-rmse-iter1.pkl', "wb"))
